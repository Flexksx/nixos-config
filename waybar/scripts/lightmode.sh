...
DIR='/home/flexksx/config/backrgrounds/light'
...
STYLE_PATH='/home/flexksx/config/waybar/style.css'
...
echo $BG > /home/flexksx/config/waybar/scripts/active_wallpaper_path.txt
HYPRLOCK_CONFIG_PATH='/home/flexksx/config/hyprland/hyprlock.conf'
